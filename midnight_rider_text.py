...
WE'VE STOLEN A CAR. WE NEED TO GET IT HOME. THE CAR IS SPECIAL.

THATS WHY THE GOVERNMENT WANTS IT.
...
CHOICES = """
    --- Your Choices ---
    B. Move Forward at normal speed
    C. Speed ahead full speed!
    D. Stop to refuel
...
EAT_TOFU = """------Mmmmmmmmm. Soybean goodness.
------Your hunger is sated.
"""

NO_TOFU = """------You have no tofu left. :sadge: 
"""
...
ENDGAME_TEXT = [
    ...
    """You have run out of hunger yikes!!!"""
]
